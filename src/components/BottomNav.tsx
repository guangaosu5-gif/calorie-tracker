          ...
          if (item.isAction) {
            return (
              <button
                ...
                className="relative -top-6 w-14 h-14 bg-gradient-to-br from-primary to-primary-dark rounded-full shadow-lg flex items-center justify-center text-white hover:shadow-xl transition-all hover:scale-105 active:scale-95"
              >
                <item.icon size={28} />
              </button>
            );
