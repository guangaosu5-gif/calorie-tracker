  ...
  const identifyFood = () => {
    ...
    setTimeout(() => {
      const foodCategories = {
        主食: ['米饭', '馒头', '面条', '面包', '饺子', '包子', '粥', '煎饼', '油条', '蛋糕'],
        肉类: ['鸡肉', '牛肉', '猪肉', '鱼肉', '鸡蛋', '鸭蛋', '鹌鹑蛋', '火腿', '香肠', '培根'],
        蔬菜: ['白菜', '青菜', '黄瓜', '西红柿', '土豆', '胡萝卜', '西兰花', '菠菜', '生菜', '芹菜'],
        水果: ['苹果', '香蕉', '橙子', '葡萄', '西瓜', '草莓', '蓝莓', '芒果', '桃子', '梨'],
        饮品: ['牛奶', '豆浆', '果汁', '可乐', '茶', '咖啡', '酸奶', '矿泉水', '啤酒', '红酒'],
